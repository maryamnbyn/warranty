    ...
    <div class="container-fluid mt--7">
                ...
                <div class="card-header bg-transparent">
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right" dir="rtl">
                            <h6 class="text-uppercase text-darker ls-1 mb-1">نمودار میله ای</h6>
                            <h2 class="text-dark mb-0">گروه خونی کاربران</h2>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="row mt-5">
            <div class="col">
                ...
                <a class="card shadow mb-2" href="{{"route('excel_emotion')"}}">
                ...
                <div class="card shadow" dir="rtl">
                    ...
                    <div class="card-header border-0 text-right">
                        <h3 class="mb-0">لیست گروه خونی کاربران</h3>
                    </div>
